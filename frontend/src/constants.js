 ...
 * - Frontend: Import using @/constants.js alias (configured in vite.config.ts)
 * - Backend: Import using relative path from backend/src/services/ai/gemini.shared.js
 * 
 * DO NOT duplicate this file. All constants should be defined here.
 */
